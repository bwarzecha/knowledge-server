...
class TestReferenceResolver:
    ...
    def test_resolve_schema_reference(self):
        ...
        chunk_id = resolver.resolve_ref_to_chunk_id(
            "#/components/schemas/Pet", "api.json"
        )
    ...
    def test_resolve_invalid_references(self):
        ...
        assert (
            resolver.resolve_ref_to_chunk_id("external.json#/schema", "api.json")
            is None
        )
    ...
    def test_different_spec_names(self):
        ...
        assert (
            resolver.resolve_ref_to_chunk_id(
                "#/components/schemas/Pet", "apis/v2/petstore.yaml"
            )
